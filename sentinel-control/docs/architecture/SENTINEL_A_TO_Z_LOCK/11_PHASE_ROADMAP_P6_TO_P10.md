...
| P6R5 Sentinel Cognitive Mechanics Review | Hard review of Sentinel as math/control/algorithm/product architecture before more L6 power | P5L, P6O/P6P, P6Q/P6R, AgentLab, context engineering research | L4 -> L4 review lock | formal state/action objective, control loop, future-or-generic verdict, P6S go/no-go |
| P6S Desktop Workspace L6 Promotion | Promote workspace file operations after context economy exists | P6P order, P6K/P6L desktop harvest, P6R context engine | L5 -> L6 | workspace adapter, compact workspace cards, receipts, rollback refs, FinalGate |
| P6T Browser Controlled Navigation L6 | Promote controlled browser navigation without login/session mutation | P6C/P6M/P6O browser evidence, P6R context engine | L5 -> L6 | allowed domains, navigation receipts, timeout budget, compact page evidence |
