...
| Pack D: Decision Context Skill Frame Simplification | `POWER_RECONNECTION_PACK_D_DECISION_CONTEXT_SKILL_FRAME_SIMPLIFICATION_V1` | implemented candidate | `pending_followup_ledger` | Added primary `skill_decision_frame`, `primary_model_*` recommendations, and legacy compatibility fields |
