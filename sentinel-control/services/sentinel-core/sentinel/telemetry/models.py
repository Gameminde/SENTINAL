...
class TelemetryEventKind(StrEnum):
    ...
    LIVE_DESKTOP_BACKEND_REGISTERED = "live_desktop_backend_registered"
    LIVE_DESKTOP_BACKEND_REJECTED = "live_desktop_backend_rejected"
    DESKTOP_OPERATOR_SESSION_STARTED = "desktop_operator_session_started"
    DESKTOP_OPERATOR_SESSION_COMPLETED = "desktop_operator_session_completed"
    DESKTOP_OPERATOR_SESSION_FAILED = "desktop_operator_session_failed"
    DESKTOP_OPERATOR_MODE_CHANGED = "desktop_operator_mode_changed"
    DESKTOP_SYSTEM_SNAPSHOT_REQUESTED = "desktop_system_snapshot_requested"
    DESKTOP_SYSTEM_SNAPSHOT_COMPLETED = "desktop_system_snapshot_completed"
    DESKTOP_SYSTEM_SNAPSHOT_BLOCKED = "desktop_system_snapshot_blocked"
    DESKTOP_MONITORING_SESSION_STARTED = "desktop_monitoring_session_started"
    DESKTOP_MONITORING_TICK_COMPLETED = "desktop_monitoring_tick_completed"
    DESKTOP_MONITORING_SESSION_STOPPED = "desktop_monitoring_session_stopped"
    DESKTOP_PROCESS_SNAPSHOT_CREATED = "desktop_process_snapshot_created"
    DESKTOP_WINDOW_SNAPSHOT_CREATED = "desktop_window_snapshot_created"
    DESKTOP_HARDWARE_METRIC_SNAPSHOT_CREATED = "desktop_hardware_metric_snapshot_created"
    DESKTOP_LIVE_ACTION_PLANNED = "desktop_live_action_planned"
    DESKTOP_LIVE_ACTION_BLOCKED = "desktop_live_action_blocked"
    DESKTOP_LIVE_ACTION_STARTED = "desktop_live_action_started"
    DESKTOP_LIVE_ACTION_COMPLETED = "desktop_live_action_completed"
    DESKTOP_LIVE_ACTION_FAILED = "desktop_live_action_failed"
    DESKTOP_LIVE_ACTION_KILL_BLOCKED = "desktop_live_action_kill_blocked"
    DESKTOP_BENCHMARK_STARTED = "desktop_benchmark_started"
    DESKTOP_BENCHMARK_COMPLETED = "desktop_benchmark_completed"
    DESKTOP_BENCHMARK_FAILED = "desktop_benchmark_failed"
    DESKTOP_SERVICE_SHAPE_CREATED = "desktop_service_shape_created"
    DESKTOP_TRAY_SHAPE_CREATED = "desktop_tray_shape_created"
    VOICE_RUNTIME_STARTED = "voice_runtime_started"
    VOICE_RUNTIME_STOPPED = "voice_runtime_stopped"
    VOICE_SESSION_STARTED = "voice_session_started"
    VOICE_SESSION_COMPLETED = "voice_session_completed"
    VOICE_SESSION_FAILED = "voice_session_failed"
    VOICE_MODE_CHANGED = "voice_mode_changed"
    VOICE_AUDIO_INPUT_STARTED = "voice_audio_input_started"
    VOICE_AUDIO_INPUT_STOPPED = "voice_audio_input_stopped"
    VOICE_ACTIVITY_DETECTED = "voice_activity_detected"
    VOICE_TURN_STARTED = "voice_turn_started"
    VOICE_TURN_ENDED = "voice_turn_ended"
    VOICE_PARTIAL_TRANSCRIPT_CREATED = "voice_partial_transcript_created"
    VOICE_FINAL_TRANSCRIPT_CREATED = "voice_final_transcript_created"
    VOICE_COMMAND_ENVELOPE_CREATED = "voice_command_envelope_created"
    VOICE_COMMAND_BLOCKED = "voice_command_blocked"
    VOICE_CONFIRMATION_REQUIRED = "voice_confirmation_required"
    VOICE_CONFIRMATION_COMPLETED = "voice_confirmation_completed"
    VOICE_BARGE_IN_DETECTED = "voice_barge_in_detected"
    ...
    VOICE_KILL_WORD_DETECTED = "voice_kill_word_detected"
    VOICE_AMBIENT_NOTIFICATION_CREATED = "voice_ambient_notification_created"
    VOICE_PROVIDER_DESCRIPTOR_REGISTERED = "voice_provider_descriptor_registered"
    VOICE_PROVIDER_DESCRIPTOR_REJECTED = "voice_provider_descriptor_rejected"
    VOICE_REPLAY_BUILT = "voice_replay_built"
    CREDENTIAL_VAULT_INITIALIZED = "credential_vault_initialized"
    CREDENTIAL_VAULT_LOCKED = "credential_vault_locked"
    CREDENTIAL_VAULT_UNLOCK_REQUESTED = "credential_vault_unlock_requested"
    CREDENTIAL_VAULT_UNLOCKED = "credential_vault_unlocked"
    CREDENTIAL_VAULT_UNLOCK_REJECTED = "credential_vault_unlock_rejected"
    CREDENTIAL_VAULT_UNLOCK_EXPIRED = "credential_vault_unlock_expired"
    SECRET_REGISTERED = "secret_registered"
    SECRET_REGISTRATION_REJECTED = "secret_registration_rejected"
    SECRET_METADATA_UPDATED = "secret_metadata_updated"
    SECRET_ACCESS_REQUESTED = "secret_access_requested"
    SECRET_ACCESS_GRANTED = "secret_access_granted"
    SECRET_ACCESS_REJECTED = "secret_access_rejected"
    SECRET_LEASE_CREATED = "secret_lease_created"
    SECRET_LEASE_EXPIRED = "secret_lease_expired"
    SECRET_LEASE_REVOKED = "secret_lease_revoked"
    SECRET_CHECKOUT_STARTED = "secret_checkout_started"
    SECRET_CHECKOUT_COMPLETED = "secret_checkout_completed"
    SECRET_CHECKOUT_REJECTED = "secret_checkout_rejected"
    SECRET_USE_STARTED = "secret_use_started"
    SECRET_USE_COMPLETED = "secret_use_completed"
    SECRET_USE_FAILED = "secret_use_failed"
    ...
    FINANCIAL_AUTHORITY_INITIALIZED = "financial_authority_initialized"
    FINANCIAL_ACTION_REQUESTED = "financial_action_requested"
    FINANCIAL_ACTION_PLANNED = "financial_action_planned"
    FINANCIAL_ACTION_BLOCKED = "financial_action_blocked"
    FINANCIAL_CHECKPOINT_CREATED = "financial_checkpoint_created"
    FINANCIAL_APPROVAL_REQUIRED = "financial_approval_required"
    FINANCIAL_APPROVAL_COMPLETED = "financial_approval_completed"
    SPEND_REQUESTED = "spend_requested"
    SPEND_PREVIEW_CREATED = "spend_preview_created"
    SPEND_BLOCKED = "spend_blocked"
    SPEND_SANDBOX_EXECUTED = "spend_sandbox_executed"
    SPEND_COMPLETED = "spend_completed"
    SPEND_FAILED = "spend_failed"
    PAYMENT_INTENT_CREATED = "payment_intent_created"
    PAYMENT_IDEMPOTENCY_RESERVED = "payment_idempotency_reserved"
    PAYMENT_DUPLICATE_BLOCKED = "payment_duplicate_blocked"
    TRANSFER_REQUESTED = "transfer_requested"
    TRANSFER_PREVIEW_CREATED = "transfer_preview_created"
    TRANSFER_BLOCKED = "transfer_blocked"
    TRADE_REQUESTED = "trade_requested"
    TRADE_ORDER_PREVIEW_CREATED = "trade_order_preview_created"
    TRADE_ORDER_BLOCKED = "trade_order_blocked"
    PAPER_TRADE_EXECUTED = "paper_trade_executed"
    TRADE_ORDER_COMPLETED = "trade_order_completed"
    TRADE_ORDER_FAILED = "trade_order_failed"
    FINANCIAL_KILL_SWITCH_TRIGGERED = "financial_kill_switch_triggered"
    FINANCIAL_REPLAY_BUILT = "financial_replay_built"
...
class TelemetryMetricKind(StrEnum):
    ...
    DESKTOP_SYSTEM_SNAPSHOT_COUNT = "desktop_system_snapshot_count"
    DESKTOP_MONITORING_TICK_COUNT = "desktop_monitoring_tick_count"
    DESKTOP_MONITORING_BLOCK_COUNT = "desktop_monitoring_block_count"
    DESKTOP_PROCESS_COUNT_SAMPLE = "desktop_process_count_sample"
    DESKTOP_WINDOW_COUNT_SAMPLE = "desktop_window_count_sample"
    DESKTOP_CPU_USAGE_SAMPLE = "desktop_cpu_usage_sample"
    DESKTOP_RAM_USAGE_SAMPLE = "desktop_ram_usage_sample"
    DESKTOP_GPU_METRIC_AVAILABLE = "desktop_gpu_metric_available"
    DESKTOP_SENSOR_METRIC_AVAILABLE = "desktop_sensor_metric_available"
    DESKTOP_ACTION_BLOCK_RATE = "desktop_action_block_rate"
    DESKTOP_KILL_BLOCK_COUNT = "desktop_kill_block_count"
    DESKTOP_REPLAY_NO_REACTION_PASS_RATE = "desktop_replay_no_reaction_pass_rate"
    DESKTOP_BENCHMARK_PASS_RATE = "desktop_benchmark_pass_rate"
    DESKTOP_BENCHMARK_FAILURE_COUNT = "desktop_benchmark_failure_count"
    VOICE_SESSION_COUNT = "voice_session_count"
    VOICE_TURN_COUNT = "voice_turn_count"
    VOICE_BARGE_IN_COUNT = "voice_barge_in_count"
    VOICE_INTERRUPT_LATENCY = "voice_interrupt_latency"
    VOICE_PARTIAL_TRANSCRIPT_COUNT = "voice_partial_transcript_count"
    VOICE_FINAL_TRANSCRIPT_COUNT = "voice_final_transcript_count"
    VOICE_COMMAND_BLOCK_RATE = "voice_command_block_rate"
    VOICE_CONFIRMATION_RATE = "voice_confirmation_rate"
    VOICE_OUTPUT_COMPLETION_RATE = "voice_output_completion_rate"
    VOICE_KILL_WORD_COUNT = "voice_kill_word_count"
    VOICE_PRIVACY_BLOCK_COUNT = "voice_privacy_block_count"
    VOICE_REPLAY_COMPLETENESS = "voice_replay_completeness"
    CREDENTIAL_VAULT_SECRET_COUNT = "credential_vault_secret_count"
    CREDENTIAL_VAULT_UNLOCK_COUNT = "credential_vault_unlock_count"
    CREDENTIAL_VAULT_UNLOCK_REJECT_COUNT = "credential_vault_unlock_reject_count"
    SECRET_ACCESS_REQUEST_COUNT = "secret_access_request_count"
    SECRET_ACCESS_REJECT_COUNT = "secret_access_reject_count"
    SECRET_LEASE_ACTIVE_COUNT = "secret_lease_active_count"
    SECRET_LEASE_REVOCATION_COUNT = "secret_lease_revocation_count"
    SECRET_CHECKOUT_COUNT = "secret_checkout_count"
    SECRET_CHECKOUT_REJECT_COUNT = "secret_checkout_reject_count"
    ...
    FINANCIAL_ACTION_REQUEST_COUNT = "financial_action_request_count"
    FINANCIAL_ACTION_BLOCK_COUNT = "financial_action_block_count"
    FINANCIAL_CHECKPOINT_COUNT = "financial_checkpoint_count"
    FINANCIAL_APPROVAL_RATE = "financial_approval_rate"
    SPEND_PREVIEW_COUNT = "spend_preview_count"
    SPEND_BLOCK_COUNT = "spend_block_count"
    SPEND_SANDBOX_EXECUTION_COUNT = "spend_sandbox_execution_count"
    PAYMENT_DUPLICATE_BLOCK_COUNT = "payment_duplicate_block_count"
    TRADE_PREVIEW_COUNT = "trade_preview_count"
    TRADE_BLOCK_COUNT = "trade_block_count"
    PAPER_TRADE_COUNT = "paper_trade_count"
    FINANCIAL_POLICY_REJECT_COUNT = "financial_policy_reject_count"
    FINANCIAL_KILL_BLOCK_COUNT = "financial_kill_block_count"
    FINANCIAL_REPLAY_NO_ACTION_PASS_RATE = "financial_replay_no_action_pass_rate"
