...
from sentinel.agent.artifact_capture import ArtifactCaptureKind, ArtifactCaptureSandbox, CapturedArtifact  # noqa: E402 — agent-layer utility used cross-layer (Wave D documented exception)
...
from sentinel.organs.browser.screenshot import BrowserScreenshotNormalizationError, BrowserScreenshotNormalizer, normalize_browser_screenshot
