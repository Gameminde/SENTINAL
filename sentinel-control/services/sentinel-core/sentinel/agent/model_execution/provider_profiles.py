...
def _default_entries() -> list[ProviderCatalogEntry]:
    return [
        ...
        _entry(
            ...
            supported_models=["muse-spark-1.2-contributor-free", "x-preview-f-free"],
            status=ProviderCatalogStatus.DIAGNOSTIC,
            real_status=ProviderRealTestStatusKind.DIAGNOSTIC_ONLY,
            ...
            recommendation=ProviderRecommendation(
                ...
                notes=[
                    ...
                    "OpenCode model listing also exposes x-preview-f-free; public display names are not used as authority.",
